...
useEffect(() => {
  ...
  return (
    <div className="w-screen relative">
     ...
     <SeoPage
      pageTitle="About - Mbboy"
      title="About Mbboy - Developer and Designer"
      description="About Mbboy: Tech Expert, Designer, and Ethical Hacker Behind Cutting-Edge Projects"
