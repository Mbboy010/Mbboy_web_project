...
export default function StatsC() {
  ...
  return (
    <div className={`flex justify-center items-center space-x-6 ${isColor ? "bg-[#d7d7d719]" : "bg-[#72727236]"}  p-5 rounded-lg`}>
      ...
      {
        isCheck ? <p className="text-orange-500  md:text-2xl font-bold">{ex}+</p> :
        <p className="h-7 w-11 cousss rounded-lg "></p>
      }
        
        <p className="text-[0.7rem] md:text-sm">Experiences</p>
      </div>
      <div className="border-l border-gray-600 h-10"></div>
      <div className="text-center flex  flex-col justify-center items-center">
      
      {
        isCheck ? <p className="text-orange-500 md:text-2xl font-bold">{pr}+</p> :
        <p className="h-7 w-11 coussstwo rounded-lg "></p>
      }
      

        <p className="text-[0.7rem] md:text-sm">Project done</p>
      </div>
      <div className="border-l border-gray-600 h-10"></div>
      <div className="text-center flex  flex-col justify-center items-center">
      {
        isCheck ? <p className="text-orange-500  md:text-2xl font-bold">{hp}+</p> :
        <p className="h-7 w-11 cousssone rounded-lg "></p>
      }

        <p className="text-[0.7rem] md:text-sm">Happy Clients</p>
      </div>
    </div>
  );
}
