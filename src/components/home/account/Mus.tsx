  ...
  return(
    <div>
      ...
      >
        ...
        <IoIosMusicalNote className=" drop-shadow-lg shadow-white text-2xl font-black text-white" />
        </div>
        <h1 className="text-1xl capitalize text-orange-500  font-black">Music production</h1>
        </div>
